        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h5 class="font-weight-bold">Fitting Room</h5>
                            <p>Fitting Room</p>
                            <a href="https://github.com/nhutrang0209/Fitting_Room" target="_blank" class="btn btn-github">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>Fitting room uses some open-source third-party libraries/packages, many thanks to the web community.</p>
                            <ul>
